...
- **Conclusion : faux positif fondé sur l'historique.** Le correctif n'est pas dans le code, il est dans la console Ads (« Faire appel »), qui déclenche un nouveau scan. Ne pas « nettoyer » le site : il n'y a rien à nettoyer.
- Si la question revient : ne jamais racheter un domaine expiré sans vérifier son passé (Wayback + Safe Browsing) — c'est exactement ce qui coûte ici une campagne bloquée.
